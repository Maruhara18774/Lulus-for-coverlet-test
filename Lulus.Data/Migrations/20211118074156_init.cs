    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("54ba416f-6b89-4c53-873d-4fbd48506e6d"), "5fa025e4-3d18-4b62-9beb-b1c3308a28fd", "Customer", "CUSTOMER" },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "3019648d-144a-45dc-ad46-48747326d9e2", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("61ae2038-97f2-45e5-91ae-08d961fa9be8"), 0, "0a7e3fed-b598-4654-88cb-581c5ea674a0", "22 St. Wall Street, Brooklyn, American", "Anna", "Lee", "annalee@shop.com", false, false, null, "ANNALEE@SHOP.COM", "ANNALEE", "AQAAAAEAACcQAAAAEMCWwmuld7TipqPKvhsvfF7tcGlJc2EpGzr8cPFgLmVetf4wEqXXKMxXPlj7xy7Bfg==", "012545454541", false, "NQLC7NG4A7DTOJ5DETPA35OHKTOZMMYP", false, "annalee" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 11, 18, 14, 41, 56, 29, DateTimeKind.Local).AddTicks(193), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(545), 1, "/Images/Product/texture/navy-blue.png", "Navy Blue" },
                    { 2, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1581), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1587), 1, "/Images/Product/texture/green.png", "Green" },
                    { 3, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1590), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1592), 2, "/Images/Product/texture/mustard-yellow-floral-print.jpg", "Mustard Yellow Floral Print" },
                    { 4, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1594), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1596), 2, "/Images/Product/texture/red-floral-print.png", "Red Floral Print" },
                    { 5, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1598), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1600), 2, "/Images/Product/texture/navy-blue-floral-print.jpg", "Navy Blue Floral Print" },
                    { 6, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1604), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1605), 3, "/Images/Product/texture/red.png", "Red" },
                    { 7, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1608), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1609), 3, "/Images/Product/texture/white.png", "White" },
                    { 8, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1613), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1614), 4, "/Images/Product/texture/royal-white.jpg", "Royal White" },
                    { 9, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1618), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1620), 4, "/Images/Product/texture/royal-blue.jpg", "Royal Blue" },
                    { 10, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1624), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1625), 5, "/Images/Product/texture/burgundy.png", "Burgundy" },
                    { 11, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1629), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1630), 6, "/Images/Product/texture/purple.jpg", "Purple" },
                    { 12, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1633), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1634), 6, "/Images/Product/texture/burgundy.png", "Burgundy" },
                    { 13, new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1636), new DateTime(2021, 11, 18, 14, 41, 56, 30, DateTimeKind.Local).AddTicks(1638), 6, "/Images/Product/texture/green.png", "Green" }
                });
